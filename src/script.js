...
loader.load(model, function (gltf) {
    obj3 = gltf.scene;
    obj3.position.set(0, -0.5, 1.95);
    obj3.rotation.z = 0
    obj3.rotation.x = 0
    obj3.scale.set(0.03, 0.03, 0.03)
    scene3.add(obj3);
});
...
function animate() {
    ...
    circlePlanet.rotation.y += 0.001;
     ...
     if (circlePo.position.z > -3 && distance == true) {
        circlePo.position.z -= 0.01;
        obj3.position.z -= 0.01;
